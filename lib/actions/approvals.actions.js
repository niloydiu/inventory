...
export async function getAllApprovals(token, filters = {}) {
  try {
    const data = await apiClient.get(APPROVALS_ENDPOINTS.BASE, filters, token);
...
export async function getPendingApprovals(token) {
  try {
    const data = await apiClient.get(APPROVALS_ENDPOINTS.PENDING, {}, token);
    return { success: true, data };
  } catch (error) {
    return { success: false, error: error.message };
  }
...
export async function getApprovalById(id, token) {
  try {
    const data = await apiClient.get(APPROVALS_ENDPOINTS.BY_ID(id), {}, token);
    return { success: true, data };
  } catch (error) {
    return { success: false, error: error.message };
  }
...
export async function createApproval(approvalData, token) {
  try {
    const data = await apiClient.post(APPROVALS_ENDPOINTS.BASE, approvalData, token);
    return { success: true, data };
  } catch (error) {
    return { success: false, error: error.message };
  }
...
export async function approveRequest(id, decision_notes, token) {
  try {
    const data = await apiClient.patch(APPROVALS_ENDPOINTS.APPROVE(id), { decision_notes }, token);
    return { success: true, data };
  } catch (error) {
    return { success: false, error: error.message };
  }
...
export async function rejectRequest(id, decision_notes, token) {
  try {
    const data = await apiClient.patch(APPROVALS_ENDPOINTS.REJECT(id), { decision_notes }, token);
    return { success: true, data };
  } catch (error) {
    return { success: false, error: error.message };
  }

...
export const livestockSchema = z.object({
  ...
  age: z.union([z.string().min(0), z.coerce.number().min(0)]).optional(),
  weight: z.union([z.string().min(0), z.coerce.number().optional()]).optional(),
  health_status: z.enum(["healthy", "sick", "under_treatment", "quarantined"]),
  tag_number: z.string().optional(),
  location_id: z.coerce.number().optional(),
  purchase_date: z.string().optional(),
  purchase_price: z.union([z.string().min(0), z.coerce.number().optional()]).optional(),
  description: z.string().optional(),
...
export const feedSchema = z.object({
  ...
  quantity: z.coerce.number().min(0, "Quantity cannot be negative"),
  unit_type: z.enum(["kg", "lbs", "bags", "tons", "liters"], {
